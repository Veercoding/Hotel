  ...
  <body>
    <header class="header">
      <nav>
        ...
        <ul class="nav__links" id="nav-links">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              <a href="wine & dine.html">WINE & DINE</a>
              <a href="itineray.html">ITINERARY</a>
        ...
        <button class="btn nav__btn"><a href="login.php">Login or Sign in</a> </button>
      </nav>
    ...
    <section class="section__container booking__container">
      <form action="booking.php" class="booking__form" method="post">
        ...
        <div class="input__group">
          ...
          <div>
            ...
            <input type="text" placeholder="Guest" name="guest" />
          </div>
        </div>
    ...
    <section class="section__container about__container" id="about">
      ...
      <div class="about__content">
        ...
        <div class="about__btn">
          <button class="btn nav__btn"><a href="about.html">Read more</a>
        </div>
      </div>
    </section>
      ...
      <div class="room__grid">
        <div class="room__card">
          ...
          <div class="room__card__details">
           ...
           <a href="booking.html"> <button class="btn">Book Now</button></a>
          </div>
        </div>
        <div class="room__card">
          <div class="room__card__image">
      ...
      <div class="section__container footer__container">
        ...
        <div class="footer__col">
          ...
          <ul class="footer__links">
            ...
            <li><a href="Team/team.php">Teams</a></li>
          </ul>
        </div>
        <div class="footer__col">
          <h4>CONTACT US</h4>
          <ul class="footer__links">
            <li><a href="#">Punjabi_Hotel@gmail.com</a></li>
          </ul>
